...
import useTradeNotification from "../hooks/useTradeNotification.jsx";
...
import { TradeNotificationContext } from "../context/TradeNotificationContext.jsx";
...
export default function App() {
  ...
  const [latestTradeUpdate, setLatestTradeUpdate] = useTradeNotification(user);

  return (
    <UserContext.Provider value={[user, setUser]}>
      <TradeNotificationContext.Provider
        value={[latestTradeUpdate, setLatestTradeUpdate]}
      >
        <Routes>
